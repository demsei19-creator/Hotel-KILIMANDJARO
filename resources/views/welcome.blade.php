    ...
    <section style="padding: 8rem 0; background-color: var(--bg-surface);">
        <div class="container">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                <!-- We simulate 3 static premium rooms for the home page -->
                @for ($i = 0; $i < 3; $i++)
                <div class="reveal-up" style="animation-delay: {{ 0.2 * $i }}s;">
                    <div style="overflow: hidden; aspect-ratio: 3/4; margin-bottom: 1.5rem; position: relative;">
                        ...
                        <img src="https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&w=800&auto=format&fit=crop" alt="Suite" style="width: 100%; height: 100%; object-fit: cover; filter: grayscale(40%); transition: transform 1s ease;">
                        <div style="position: absolute; bottom: 1.5rem; left: 1.5rem; z-index: 2;">
                            <h3 style="font-size: 1.5rem; color: #fff; margin-bottom: 0.25rem; font-family: var(--font-display);">Suite Exécutive</h3>
                            <p style="color: var(--accent-gold); font-family: var(--font-body); font-size: 0.9rem; letter-spacing: 0.1em;">À partir de 150 000 FCFA</p>
                        </div>
                    </div>
                </div>
                @endfor
